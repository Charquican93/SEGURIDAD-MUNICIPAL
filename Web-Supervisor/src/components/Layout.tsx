...
const Layout: React.FC<LayoutProps> = ({ children, title }) => {
  ...
  const menuItems = [
    ...
    { 
      ...
      path: '/turnos', 
      icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> 
    },
    { 
      label: 'Mensajería', 
      path: '/mensajes', 
  ...
  return (
    <div className="app-container">
      ...
      <style>{`
        ...
        /* Scrollbar estilizado y moderno (Global para toda la App) */
        * {
